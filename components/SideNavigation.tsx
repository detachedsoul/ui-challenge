...
const SideNavigation = (): JSX.Element => {
    return (
        <div className="w-auto bg-[#f7f8fa] border-r border-[#ebecf2] h-screen overflow-y-auto sticky top-0 p-5 flex flex-col justify-between gap-[100%] custom-scrollbar">
            <div className="flex flex-col gap-5 place-items-center">
                ...
                <Link href="">
                    <svg className="hover:stroke-[#34caa5]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="p-2 bg-white rounded-[6.25rem] flex flex-col items-center gap-2">
